        ...
        if ($countUser == 0) {
          $_SESSION["msg"] = "Your email or password is invalid";
            ...
            while ( $row = mysqli_fetch_array( $authUser ) ) {
              ...
              if( $_SESSION["role"] == 1 || $_SESSION["role"] == 2 || $_SESSION["role"] == 3 || $_SESSION["role"] == 4 || $_SESSION["role"] == 5){
                ...
                $_SESSION["msg"] = "You have successfully logged in User but not allowed in the system";
              }
          }
        }
